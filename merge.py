...
def main():
    ...
    try:
        ...
        # Python command is now hardcoded as default
        python_command = "/grid/common/pkgsData/python-v3.9.6t1/Linux/RHEL8.0-2019-x86_64/bin/python3.9"
        print(f"   Using default Python command for LSF: {python_command}")
    ...
    for job_id in job_ids:
        runtime, _ = get_job_report(job_id) # We only need runtime here
